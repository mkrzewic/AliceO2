...
{
  auto dataHeader = o2::Header::get<o2::Header::DataHeader>(headerBuffer);
  auto shmHeader = o2::Header::get<o2::Header::BoostShmHeader>(headerBuffer);
  ...
  if (shmHeader) {
    assert((*reinterpret_cast<const o2::SharedMemory::IdType*>(dataBuffer) == shmHeader->id));
  }
