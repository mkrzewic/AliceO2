...
using namespace o2::SharedMemory;

//______________________________________________________________________________
o2::SharedMemory::Manager::Manager(size_t size, size_t bufferSize, std::string bufferName, std::string segmentName)
  : mSegment{ nullptr },
...
//______________________________________________________________________________
bool o2::SharedMemory::Manager::waitForMemory(const boost::posix_time::time_duration& timeout)
{
...
//______________________________________________________________________________
BlockPtr o2::SharedMemory::Manager::allocate(size_t size) noexcept
{
...
//______________________________________________________________________________
void o2::SharedMemory::Manager::deallocate(Block* block)
{
  if (!block)
    return;
...
//______________________________________________________________________________
BlockPtr o2::SharedMemory::Manager::getBlock(HandleType handle, IdType id)
{
...
//______________________________________________________________________________
void o2::SharedMemory::Manager::registerBlock(BlockPtr& block)
{
  bi::scoped_lock<bi::interprocess_mutex> lock(*mMutexBufferAccess);
...
//______________________________________________________________________________
void o2::SharedMemory::Manager::deregisterBlock(BlockPtr& block)
{
  bi::scoped_lock<bi::interprocess_mutex> lock(*mMutexBufferAccess);
  if (!block) {
    return;
...
//______________________________________________________________________________
IdType o2::SharedMemory::Manager::getUniqueID()
{
